...
const ProductDetails = () => {
  ...
  useEffect(() => {
    if (product) {
      const updatedProductPrice = product.price + ramPrice + storagePrice;
      setTotalPrice(updatedProductPrice * productCount);
    }
  }, [product, productCount, ramPrice, storagePrice]);
  ...
  const addToCart = async (id, quantity) => {
    if (userLoggedIn) {
      ...
      toast.error("Please log to buy product.");
    }
  };
  ...
  const handleRAMOptionChange = (option, price) => {
    ...
    setRamPrice(price);
    const updatedProductPrice = product.price + price + storagePrice;
    setTotalPrice(updatedProductPrice * productCount);
  };
  ...
  const handleStorageOptionChange = (option, price) => {
    ...
    const updatedProductPrice = product.price + ramPrice + price;
    setTotalPrice(updatedProductPrice * productCount);
  };
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      const updatedProductPrice =
                        product.price + ramPrice + storagePrice;
                      setTotalPrice(updatedProductPrice * newCount);
                    }}
                  />
