...
const Orders = () => {
    ...
    const fetchOrders = () => {
        axios.get(`http://localhost:8083/OrderPage/Show_All_Orders/User?token=${localStorage.getItem("AccessToken")}`)
        .then((res) => {
    ...
    const cancelOrder = (orderId) => {
        axios.post(`http://localhost:8083/OrderPage/Cancel_Order?orderId=${orderId}&token=${localStorage.getItem("AccessToken")}`)
        .then((res) => {
