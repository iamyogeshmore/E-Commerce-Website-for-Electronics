...
//     const fetchUserData = () => {
//         axios.get(`http://localhost:8083/UserPage/Get_Data/user?token=${localStorage.getItem("AccessToken")}`)
//         .then((res) => {
...
//         axios.get(`http://localhost:8083/CartPage/Get_Total-Cart_Amount-Qty?token=${localStorage.getItem("AccessToken")}`)
//         .then((res)=> {
//             console.log(res.data.obj);
...
//     const placeOrder = () => {
//         axios.post(`http://localhost:8083/OrderPage/placeOrder?token=${localStorage.getItem("AccessToken")}`,shippingAddress)
//         .then((res) => {
